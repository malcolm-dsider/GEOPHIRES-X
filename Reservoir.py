...
from Parameter import intParameter, floatParameter, strParameter, OutputParameter, ReadParameter
from Units import *
import Model
...
class Reservoir:
    ...
    def __init__(self, model:Model):
        ...
        self.gradient = self.ParameterDict[self.gradient.Name] = floatParameter("Gradients", value = [50.0,0.0,0.0,0.0], DefaultValue=[50.0,0.0,0.0,0.0], Min=0.0, Max=500.0, UnitType = Units.TEMP_GRADIENT, PreferredUnits = TemperatureGradientUnit.DEGREESCPERKM, CurrentUnits = TemperatureGradientUnit.DEGREESCPERKM, Required=True, ErrMessage = "assume default geothermal gradients 1 (50, 0, 0, 0 deg.C/km)", ToolTipText="Geothermal gradients")
        self.gradient1 = self.ParameterDict[self.gradient1.Name] = floatParameter("Gradient 1", value = 50.0, DefaultValue=50.0, Min=0.0, Max=500.0, UnitType = Units.TEMP_GRADIENT, PreferredUnits = TemperatureGradientUnit.DEGREESCPERKM, CurrentUnits = TemperatureGradientUnit.DEGREESCPERKM, Required=True, ErrMessage = "assume default geothermal gradient 1 (50 deg.C/km)", ToolTipText="Geothermal gradient 1 in rock segment 1")
