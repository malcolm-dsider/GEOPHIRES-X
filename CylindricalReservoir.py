...
class Reservoir:
    ...
    def __init__(self, model:Model):
        ...
        self.layerthickness = self.ParameterDict[self.layerthickness.Name] = listParameter("Thickness 1", value = [0.0, 100_000.0, 100_000.0, 100_000.0], DefaultValue=[0.0, 100_000.0, 100_000.0, 100_000.0], Min=0.01, Max=100.0, UnitType = Units.LENGTH, PreferredUnits = LengthUnit.KILOMETERS, CurrentUnits = LengthUnit.KILOMETERS, ErrMessage = "assume default layer thickness (2 km)", ToolTipText="Thickness of rock segment")
            ...
            for item in self.ParameterDict.items():
                ...
                if key in model.InputParameters:
                    ...
                    if ParameterToModify.Name == "Reservoir Model":
                        ...
                        ParameterToModify.value[position] = ParameterToModify.value[position] / 1000.0   #convert 0 C/m
                        ...
                        parts = ParameterReadIn.Name.split(' ')
                        position = int(parts[1]) - 1
                        ParameterToModify.value[position] = ParameterToModify.value[position] * 1000.0 #convert m
                        ParameterToModify.value[position+1] = 100_000.0            # set thickness of bottom segment to large number to override lower, unused segments
