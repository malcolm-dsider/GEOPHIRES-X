...
class EconomicsCCUS(Economics.Economics):
    def __init__(self, model:AdvModel):
        ...
        self.CCUSEndPrice = self.ParameterDict[self.CCUSEndPrice.Name] = floatParameter("Ending CCUS Credit Value", value = 0.0, DefaultValue=0.0, Min=0, Max=1000, UnitType = Units.COSTPERMASS, PreferredUnits = CostPerMassUnit.DOLLARSPERLB, CurrentUnits = CostPerMassUnit.DOLLARSPERLB)
        ...
        self.CCUSEscalationRate = self.ParameterDict[self.CCUSEscalationRate.Name] = floatParameter("CCUS Escalation Rate Per Year", value = 0.0, DefaultValue=0.0, Min=0.0, Max = 100.0, UnitType = Units.COSTPERMASS, PreferredUnits = CostPerMassUnit.DOLLARSPERMT, CurrentUnits = CostPerMassUnit.DOLLARSPERMT, ErrMessage="assume no CCUS credit escalation (0.0)", ToolTipText="additional value per year of price after escalation starts")
        self.CCUSStartPrice = self.ParameterDict[self.CCUSStartPrice.Name] = floatParameter("Starting CCUS Credit Value", value = 0.0, DefaultValue=0.0, Min=0, Max=1000, UnitType = Units.COSTPERMASS, PreferredUnits = CostPerMassUnit.DOLLARSPERMT, CurrentUnits = CostPerMassUnit.DOLLARSPERMT)
        self.CCUSGridCO2 = self.ParameterDict[self.CCUSGridCO2.Name] = floatParameter("Current Grid CO2 production", value = 0.0, DefaultValue=0.0, Min=0, Max=50000, UnitType = Units.CO2PRODUCTION, PreferredUnits = CO2ProductionUnit.LBSPERKWH, CurrentUnits = CO2ProductionUnit.LBSPERKWH)
